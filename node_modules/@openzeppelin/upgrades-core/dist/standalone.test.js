...
test('reports unsafe operation - fully qualified name', t => {
    const impl = new standalone_1.UpgradeableContract('contracts/test/Standalone.sol:StandaloneV1', t.context.solcInput, t.context.solcOutput);
    const report = impl.getErrorReport();
    t.false(report.ok);
    t.true(report.errors[0].kind === 'delegatecall');
});
...
test('dont report renamed version update', t => {
    const v1 = new standalone_1.UpgradeableContract('StandaloneRenameV1', t.context.solcInput, t.context.solcOutput);
    const v2 = new standalone_1.UpgradeableContract('StandaloneRenameV2', t.context.solcInput, t.context.solcOutput);
    const goodReport = v1.getStorageUpgradeReport(v2);
    t.true(goodReport.ok);
    const v3 = new standalone_1.UpgradeableContract('StandaloneRenameV3', t.context.solcInput, t.context.solcOutput);
